					...
					<div class="widget-header">
						<div class="row">
							<div class="col-xl-12 col-md-12 col-sm-12 col-12">
								<h4>{{__('Manage Profession')}}</h4>
							</div>
						</div>
					</div>
					<form action="{{route('profession.index')}}" method="GET">
						<div class="widget-content widget-content-area">
							<div class="row">
								<div class="col-md-4">
									<input type="text" class="form-control mb-3 mb-md-0" name="profession_title" placeholder="Profession Title" value="{{$request->profession_title}}"> 
								</div>
