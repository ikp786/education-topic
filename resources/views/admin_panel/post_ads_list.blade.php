                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>{{__('Manage Post Ads')}}</h4>
                            </div>
                        </div>
                    </div>
                    <form action="{{route('post_ads.index')}}" method="GET">
                                ...
                                <tbody>
                                    @if(count($record_list) > 0)
                                        @foreach($record_list as $record)
                                            <tr>
                                                <td>
                                                    @if(!empty($record->ad_image))
                                                        <img src="{{asset('storage/postad_images')}}/{{$record->ad_image}}" width="100" />
                                                    @else
