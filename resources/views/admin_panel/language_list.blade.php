                ...
                <div class="statbox widget box box-shadow mb-1">
                    ...
                    <form action="{{route('language.index')}}" method="GET">
                        <div class="widget-content widget-content-area">
                            <div class="row">
                                <div class="col-md-4">
                                    <input type="text" class="form-control mb-3 mb-md-0" name="language_title" placeholder="Language Title" value="{{$request->language_title}}"> 
                                </div>
