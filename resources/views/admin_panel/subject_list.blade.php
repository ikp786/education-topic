                ...
                <div class="statbox widget box box-shadow mb-1">
                    ...
                    <form action="{{route('subject.index')}}" method="GET">
                        <div class="widget-content widget-content-area">
                            <div class="row">
                                <div class="col-md-4">
                                    <input type="text" class="form-control mb-3 mb-md-0" name="subject_title" placeholder="Subject Title" value="{{$request->subject_title}}"> 
                                </div>
